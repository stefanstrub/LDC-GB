...
class GBGPU(object):
    ...
    def run_wave(
        ...
        *args,
        ...
        XYZf, self.f_min = self._computeXYZ(T, Gs, f0, fdot, fddot, fstar, amp, q, tm)

        self.start_inds = self.kmin = self.xp.round(self.f_min/df).astype(int)
        fctr = 0.5 * T / N
    ...
    def get_ll(
        ...
        **kwargs,
        ...
        Args:
            params (2D or 3D double np.ndarrays): Parameters of all binaries to be calculated.
