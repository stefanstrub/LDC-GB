...
pGB = dict(zip(vgb.dtype.names, vgb[13])) # we take the source #8
...
'EclipticLongitude': [0.0, 2.0*np.pi],'Frequency': [pGB['Frequency']*0.9999,pGB['Frequency']*1.0001],'FrequencyDerivative': [10**-20.0, 10**-16.0],
