...
save_name = 'LDC1-4_4mHz_fd_positive'
...
plt.plot(f_line, frequency_derivative_thyson(f_line))
plt.plot(f_line, frequency_derivative_thyson_lower(f_line))
